...
<html lang="zh">
    <head>
        ...
        <title><?PHP echo $ordinary_main['info']['xfs_title']['text']; ?> | 文件添加-管理终端</title>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="fs-5 fw-bold"><i class="bi bi-sliders2"></i> 文件添加</div>
                        </div>
                        <div class="col-12 mb-3">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label class="form-label fw-bold">文件标题</label>
                                    <input type="text" class="form-control" id="file_title" name="file_title" placeholder="例：XF-Share稳定版" required>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="formFile" class="form-label  fw-bold">文件介绍 <i class="bi bi-markdown"></i></label>
                                    <textarea class="form-control" rows="10" id="file_text" name="file_text" required></textarea>
                                </div>
                                <div class="col-12 mb-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" id="file_type" name="file_type" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="file_version" name="file_version" placeholder="例：1.0.0" required>
                                </div>
                            </div>
                        </div>
                    </div>
