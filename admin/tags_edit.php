...
// 载入标签信息
$tags_url = $_SERVER['HTTP_HOST'].'/api/article/select/tags.php?ssid='.xfs_ssid().'&tags='.$tags_id;    
...
<html lang="zh">
    <head>
        ...
        <title><?PHP echo $ordinary_main['info']['xfs_title']['text']; ?> | 标签编辑 - 管理终端</title>
...
?>
<form action="./plugins/tags_edit_upload.php?tags_id=<?PHP echo $tags_id; ?>" method="post" enctype="multipart/form-data">
<div class="container">
    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-lg-9 col-xl-10"><input type="text" class="form-control" id="tags_name" name="tags_name" value="<?PHP echo $tags['data']['name'];?>"></div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-lg-9 col-xl-10"><input type="text" class="form-control" id="tags_lore" name="tags_lore" value="<?PHP echo $tags['data']['lore'];?>"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
