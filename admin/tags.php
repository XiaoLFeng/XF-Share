...
// 载入标签信息
$tags_url = $_SERVER['HTTP_HOST'].'/api/article/select/all_tags.php?ssid='.xfs_ssid().'&array=1';    
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="fs-5 fw-bold"><i class="bi bi-sliders2"></i> 标签列表</div>
                        </div>
                        <div class="col-12">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?PHP echo $tags['data'][$num]['name']; ?></td>
                                        <td><?PHP echo $tags['data'][$num]['lore']; ?></td>
                                        <td>
                                            <?PHP 
                                            if ($tags['data'][$num]['tags'] == 1) {
                                            } else {
                                            ?>
                                            <a class="btn btn-sm btn-outline-primary" href="./tags_edit.php?tags_id=<?PHP echo $tags['data'][$num]['tags']; ?>" role="button"><i class="bi bi-pencil"></i> 修改</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-12">您确认删除 <strong><?PHP echo $tags['data'][$num]['name']; ?></strong> 标签吗？</div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a class="btn btn-danger text-white" href="./plugins/tags_delete_upload.php?tags_id=<?PHP echo $tags['data'][$num]['tags']; ?>" role="button"><i class="bi bi-exclamation-circle"></i> 我确认</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="card rounded-3 shadow-sm">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row px-4">
                                <a class="btn btn-outline-success mb-2" href="./tags_add.php" role="button"><i class="bi bi-file-earmark-plus"></i> 添加标签</a>
                                <a class="btn btn-outline-success mb-2" href="./article.php" role="button"><i class="bi bi-pencil-square"></i> 文章管理</a>
